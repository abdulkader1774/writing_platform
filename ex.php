        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                ...
                if ($featuredPost) {
                    ...
                    echo '<a href="view.php?id=' . $featuredPost['id'] . '" class="btn btn-read">Read Full Story</a>';
                    echo '</div>';
                    echo '</div>';
                } else {
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <h5>WriteSpace</h5>
                    <p>A platform for writers to share their stories and connect with readers worldwide. Join our community today!</p>
                    <div class="mt-3">
